set VSVARS_PATH="C:\Program Files (x86)\Microsoft Visual Studio\2022\Preview\VC\Auxiliary\Build\vcvars32.bat"
set QMAKE_PATH="C:\Qt\6.8.2\msvc2022_64\bin\qmake.exe"
